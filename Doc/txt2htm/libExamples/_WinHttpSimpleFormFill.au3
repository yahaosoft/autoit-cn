...
;         - set "MyUserName" data to user-name input box. Locate input box by its Id. It's "username"
;         - set "MyPassword" data to password input box. Locate input box by its Id. It's "passwd"
;         - gather data
...
_WinHttpCloseHandle($hConnect)
; Close session handle
_WinHttpCloseHandle($hOpen);Print returned:
