...
MsgBox(4096, "工作表标签名称", "当前活动工作表标签名称是:" & @CRLF & _ExcelSheetNameGet($oExcel))

MsgBox(4096, "退出", "按确定保存文件并退出")
...
MsgBox(4096, "工作表标签名称", "新活动工作表标签名称是:" & @CRLF & _ExcelSheetNameGet($oExcel))
