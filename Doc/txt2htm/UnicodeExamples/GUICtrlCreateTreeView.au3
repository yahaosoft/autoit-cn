		...
		Select
			...
			Case $msg = $infobutton
				...
				Else
					...
					If $text == "" Then
						MsgBox(16, "错误", "Error while retrieving infos about item")
					Else
						MsgBox(4160, "TreeView Demo", "Current item selected is: " & $text) ; $advmsg[0] contains the text and $advmsg[1] the state value of the treeview item
					EndIf
				EndIf
