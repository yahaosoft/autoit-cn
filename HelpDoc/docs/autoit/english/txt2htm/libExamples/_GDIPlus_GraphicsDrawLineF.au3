...
Func Example()
	...
	Do
		...
		_GDIPlus_GraphicsDrawEllipseF($hGfxCtxt, $iWidth - $iRadius / 2 + $iRadius / 18, $iHeight - $iRadius / 2 + $iRadius / 18, $iRadius - $iRadius / 9, $iRadius - $iRadius / 9, $hPen) ;draw ellipse
		_GDIPlus_GraphicsDrawLineF($hGfxCtxt, $iWidth + Cos($iAngle * $iDeg) * $iRadius, $iHeight + Sin($iAngle * $iDeg) * $iRadius, _ ;draw line
