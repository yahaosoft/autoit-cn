...
Func Example()
	...
	Do
		...
		_GDIPlus_GraphicsDrawImageRectRectF($hGfxCtxt, $hBmp, 0, 0, $iW, $iH, $iX, $iY, $iW / 2, $iH) ;draw bitmap to backbuffer by halving the width
		_GDIPlus_GraphicsDrawImageRectF($hGraphics, $hBitmap, 0, 0, $iWidth, $iHeight) ;copy drawn bitmap to graphics handle (GUI)
