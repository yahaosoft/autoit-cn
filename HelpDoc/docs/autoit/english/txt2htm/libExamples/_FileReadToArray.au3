...
Func Example()
	...
	$aRetArray = _FileReadToArray($sFilePath, $FRTA_NOCOUNT)
	...
	; Re-read it - with count
	$aRetArray = _FileReadToArray($sFilePath, Default, ",")
	...
	$aRetArray = _FileReadToArray($sFilePath, $FRTA_COUNT + $FRTA_INTARRAYS, ",")
	...
	$aRetArray = _FileReadToArray($sFilePath, $FRTA_NOCOUNT + $FRTA_ENTIRESPLIT, ":|")
