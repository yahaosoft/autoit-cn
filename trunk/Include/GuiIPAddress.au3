...
;~ 	ConsoleWrite('0x' & Hex(BitOR($ES_WANTRETURN, $WS_VSCROLL, $WS_HSCROLL, $ES_AUTOVSCROLL, $ES_AUTOHSCROLL)) & @LF)
	...
	$hIPAddress = HWnd(_WinAPI_CreateWindowEx($iExstyles, "SysIPAddress32", "", $iStyle, $iX, $iY, $iWidth, $iHeigth, $hWnd))
...
Func _GUICtrlIpAddress_ValidateClassName($hWnd)
	...
	_WinAPI_ValidateClassName($hWnd, "SysIPAddress32")
