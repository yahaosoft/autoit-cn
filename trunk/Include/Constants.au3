...
Global Const $MOUSEEVENTF_LEFTUP = 0x4 ; Specifies that the left button changed to up
Global Const $MOUSEEVENTF_RIGHTDOWN = 0x8 ; Specifies that the right button changed to down
Global Const $MOUSEEVENTF_RIGHTUP = 0x10 ; Specifies that the right button changed to up
Global Const $MOUSEEVENTF_MIDDLEDOWN = 0x20 ; Specifies that the middle button changed to down
Global Const $MOUSEEVENTF_MIDDLEUP = 0x40 ; Specifies that the middle button changed to up
Global Const $MOUSEEVENTF_WHEEL = 0x800 ; Specifies that the wheel has been moved, if the mouse has a wheel
