...
Global Const $__LISTVIEWCONSTANT_WS_VISIBLE = 0x10000000
Global Const $__LISTVIEWCONSTANT_WS_CHILD = 0x40000000
...
;_WM_NOTIFY_UDF_INTERNAL_LV_SORT
;==============================================================================================================================
...
; #INTERNAL_USE_ONLY#============================================================================================================
; Name...........: _GUICtrlListView_Draw
; Description ...: Draws an image list item in the specified device context
; Syntax.........: _GUICtrlListView_Draw($hWnd, $iIndex, $hDC, $iX, $iY[, $iStyle=0])
; Parameters ....: $hWnd        - Handle to the control
...
;                  $fArrows     - Draws a down-arrow/up-arrow on column selected
; Return values .: Success - True
;                  Failure - False
; Author ........: Gary Frost
; Modified.......:
...
; Related .......: _GUICtrlListView_UnRegisterSortCallBack
; Link ..........;
; Example .......; Yes
; ===============================================================================================================================
Func _GUICtrlListView_RegisterSortCallBack($hWnd, $fNumbers = True, $fArrows = True)
	...
	If $iIndex = 1 Then _
			GUIRegisterMsg($__LISTVIEWCONSTANT_WM_NOTIFY, "_WM_NOTIFY_UDF_INTERNAL_LV_SORT")
...
Func _GUICtrlListView_SetGroupInfo($hWnd, $iGroupID, $sHeader, $iAlign = 0)
	...
	If IsHWnd($hWnd) Then
		If _WinAPI_InProcess($hWnd, $_lv_ghLastWnd) Then
			DllStructSetData($tGroup, "Header", $pHeader)
			$iResult = _SendMessage($hWnd, $LVM_SETGROUPINFO, $iGroupID, $pGroup, 0, "wparam", "ptr")
			DllStructSetData($tGroup, "Mask", $LVGF_GROUPID)
			DllStructSetData($tGroup, "GroupID", $iGroupID)
			_SendMessage($hWnd, $LVM_SETGROUPINFO, $iGroupID, $pGroup, 0, "wparam", "ptr")
		Else
			$pMemory = _MemInit($hWnd, $iGroup + $iHeader, $tMemMap)
			$pText = $pMemory + $iGroup
			DllStructSetData($tGroup, "Header", $pText)
			_MemWrite($tMemMap, $pGroup, $pMemory, $iGroup)
			_MemWrite($tMemMap, $pHeader, $pText, $iHeader)
			$iResult = _SendMessage($hWnd, $LVM_SETGROUPINFO, $iGroupID, $pMemory, 0, "wparam", "ptr")
			DllStructSetData($tGroup, "Mask", $LVGF_GROUPID)
			DllStructSetData($tGroup, "GroupID", $iGroupID)
			_SendMessage($hWnd, $LVM_SETGROUPINFO, $iGroupID, $pMemory, 0, "wparam", "ptr")
			_MemFree($tMemMap)
		EndIf
		_WinAPI_InvalidateRect($hWnd)
	Else
...
; Description ...: For use with _WM_NOTIFY_UDF_INTERNAL_LV_SORT
...
; Modified.......:
; Remarks .......: For Internal Use Only
; Related .......: _WM_NOTIFY_UDF_INTERNAL_LV_SORT
; Link ..........;
; Example .......;
; ===============================================================================================================================
...
; #INTERNAL_USE_ONLY#============================================================================================================
; Name...........: _WM_NOTIFY_UDF_INTERNAL_LV_SORT
; Description ...: Notification event for Column Click Events to call the Sort message
; Syntax.........: _WM_NOTIFY_UDF_INTERNAL_LV_SORT($hWnd, $iMsg, $iwParam, $ilParam)
; Parameters ....: $hWnd        - Handle of the control
;                  $iMsg        - Message
;                  $iwParam     - wParam
;                  $ilParam     - lParam
...
; Example .......;
; ===============================================================================================================================
Func _WM_NOTIFY_UDF_INTERNAL_LV_SORT($hWnd, $iMsg, $iwParam, $ilParam)
...
EndFunc   ;==>_WM_NOTIFY_UDF_INTERNAL_LV_SORT