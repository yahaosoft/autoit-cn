...
Func _GUICtrlDTP_Create($hWnd, $iX, $iY, $iWidth = 120, $iHeight = 21, $iStyle = 0x00000000, $iExStyle = 0x00000000)
	...
	Return _WinAPI_CreateWindowEx($iExStyle, "SysDateTimePick32", "", $iStyle, $iX, $iY, $iWidth, $iHeight, $hWnd)
...
Func _GUICtrlDTP_GetMCFont($hWnd)
	_WinAPI_ValidateClassName($hWnd, "SysDateTimePick32")
...
; Description ...: Used for debugging when creating examples
; Syntax.........: _GUICtrlDTP_ValidateClassName($hWnd[, $iLine = @ScriptLineNumber])
; Parameters ....: $hWnd        - Handle to the control
; Return values .: None
; Author ........: Gary Frost (gafrost)
; Modified.......:
