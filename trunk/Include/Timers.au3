...
; #INTERNAL_USE_ONLY#============================================================================================================
; Name...........: _Timer_ArrayDelete
; Description ...: Deletes the specified element from the given array.
; Syntax.........: _Timer_ArrayDelete(ByRef $avArray, $iElement)
...
;                  Renamed for use with timer functions only.
; Related .......:
; Link ..........;
; Example .......;
; ===============================================================================================================================
Func _Timer_ArrayDelete(ByRef $avArray, $iElement)
...
Func _Timer_KillAllTimers($hWnd)
	...
	For $x = UBound($_Timers_aTimerIDs) - 1 To 1 Step -1
		...
		_Timer_ArrayDelete($_Timers_aTimerIDs, $x)
...
Func _Timer_SetTimer($hWnd, $iElapse = 250, $sTimerFunc = "", $iTimerID = -1)
	Local $iResult, $pTimerFunc = 0, $hCallBack = 0, $iIndex = $_Timers_aTimerIDs[0][0] + 1
