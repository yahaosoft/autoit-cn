...
Func _GUICtrlSlider_Create($hWnd, $iX, $iY, $iWidth = 100, $iHeight = 20, $iStyle = 0x0001, $iExStyle = 0x00000000)
	...
	$hSlider = _WinAPI_CreateWindowEx($iExStyle, "msctls_trackbar32", "", $iStyle, $iX, $iY, $iWidth, $iHeight, $hWnd)
...
; Description ...: Used for debugging when creating examples
; Syntax.........: _GUICtrlSlider_ValidateClassName($hWnd[, $iLine = @ScriptLineNumber])
; Parameters ....: $hWnd        - Handle to the control
; Return values .: None
; Author ........: Gary Frost (gafrost)
; Modified.......:
...
Func _GUICtrlSlider_ValidateClassName($hWnd)
	...
	_WinAPI_ValidateClassName($hWnd, "msctls_trackbar32")
