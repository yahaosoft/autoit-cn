...
Func _GUICtrlAVI_Create($hWnd, $sFile = "", $subfileid = -1, $iX = 0, $iY = 0, $iWidth = 0, $iHeight = 0, $iStyle = 0x00000006, $iExStyle = 0x00000000)
	...
	$hAVI = _WinAPI_CreateWindowEx($iExStyle, "SysAnimate32", "", $iStyle, $iX, $iY, $iWidth, $iHeight, $hWnd)
...
; Description ...: Used for debugging when creating examples
; Syntax.........: _GUICtrlAVI_ValidateClassName($hWnd[, $iLine = @ScriptLineNumber])
; Parameters ....: $hWnd        - Handle to the control
; Return values .: None
; Author ........: Gary Frost
; Modified.......:
...
; Example .......;
; ===============================================================================================================================
Func _GUICtrlAVI_ValidateClassName($hWnd, $sType = "SysAnimate32")
